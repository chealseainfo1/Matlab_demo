function compare_algorithms_case_II
    ...
    for i = 1:size(lambdas_mus, 1)
        ...
        % Run both algorithms for Case II
...
function [errors, iter] = run_original_algorithm_case_II(lam, mu, T, t_values, c)
...
function [errors, iter] = run_new_algorithm_case_II(lam, mu, T, t_values, c)
    x_n = 3 * t_values.^2 + 2 * t_values + 5;
    errors = [];
